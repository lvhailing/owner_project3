...
public class OverseaProjectDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initTopTitle() {
        ...
        title.setTitle(getResources().getString(R.string.title_null)).setLogo(R.drawable.icons, false)
                .setIndicator(R.mipmap.icon_back).setCenterText(getResources().getString(R.string.title_oversea_project_detail))
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_support_facilities_click:  // 配套设施
                if (!isShow) {
                    ...
                    tv_support_facilities_desc.setText("");
            ...
            case R.id.iv_geographic_location_click:  // 地理位置
                if (!isShow) {
                    ...
                    tv_geographic_location_desc.setText("");
