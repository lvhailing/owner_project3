...
public class RenGouStatusActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SubcribeFragment fragment1; // 已认购
    private TurnSignFragment fragment2; // 转签约
    private UnSubcribeFragment fragment3; // 已退订
    ...
    private void initView() {
        ...
        StringUtil.changeButtonStyleRenGou(tv_subscribed, tv_to_sign, tv_unsubscribe,R.id.tv_subscribed, mResource);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.tv_subscribed: // 已认购
                ...
                transaction.commit();
                break;
            case R.id.tv_to_sign: // 转签约
                StringUtil.changeButtonStyleRenGou(tv_subscribed, tv_to_sign, tv_unsubscribe, R.id.tv_to_sign, mResource);
                hideFragment(transaction);
                fragment2 = new TurnSignFragment();
                transaction.replace(R.id.fragment_container, fragment2);
                transaction.commit();
                break;
            case R.id.tv_unsubscribe: // 已退订
                StringUtil.changeButtonStyleRenGou(tv_subscribed, tv_to_sign, tv_unsubscribe, R.id.tv_unsubscribe, mResource);
                hideFragment(transaction);
