...
public class SystemInfo {
    ...
    private static void getDeviceInfo(Context context) {
        Log.e(TAG, "Imei" + getImei(context));
        String key = "devid";
        ...
        if (devid == null) {
            sDeviceId = StringUtil.MD5Encode(getImei(context) + getLocalMacAddress(context));
        ...
        if (DEBUG) {
            Log.w("SystemInfo", "deviceid=" + sDeviceId + " sNetworkType=" + sNetworkType + " sChannel=" + sChannel);
        }
        // channel info
    ...
    public static String redUMENGChannelId(Context paramContext) {
        ...
        try {
            ...
            ApplicationInfo localApplicationInfo = localPackageManager.getApplicationInfo(paramContext.getPackageName(), PackageManager.GET_META_DATA);
            ...
            if (localApplicationInfo != null && (localApplicationInfo.metaData != null)) {
                ...
                if (localObject2 != null) {
                    ...
                    if (str != null) {
                        ...
                        Log.e(TAG, "Could not read UMENG_CHANNEL meta-data from AndroidManifest.xml.");
                    }
                }
            }
    ...
    public static String redBAIDUChannelId(Context paramContext) {
        ...
        try {
            ...
            if (localApplicationInfo != null && (localApplicationInfo.metaData != null)) {
                Object localObject2 = localApplicationInfo.metaData.get("BaiduMobAd_CHANNEL");
                if (localObject2 != null) {
                    String str = localObject2.toString();
                    if (str != null) {
                        localObject1 = str;
                    } else {
                        Log.e(TAG, "Could not read BaiduMobAd_CHANNEL meta-data from AndroidManifest.xml.");
                    }
                }
            }
        } catch (Exception localException) {
    ...
    public static void getDisplayWH(Context context) {
        ...
        if (DEBUG) {
            Log.w("SystemInfo", "sWidth=" + sWidth + " sHeight=" + sHeight + ":sCardImgHeight=" + sCardImgHeight);
        }
    }
