...
package com.haidehui.photo_preview.ScaleImageView;
...
import com.haidehui.photo_preview.LogUtil;
...
public class SubsamplingScaleImageView extends View {
    ...
    public final void setImage(ImageSource imageSource, ImageSource previewSource,
        ...
        if (sourceUri != null) {
            LogUtil.d(TAG, "setImage" + "uri:" + sourceUri.toString() + "id" + System.identityHashCode(this));
        }
        if (imageSource == null) {
        ...
        if (anim != null && !anim.interruptible) {
            ...
            if (anim != null && anim.listener != null) {
                try {
                    ...
                    LogUtil.w(TAG, "Error thrown by animation listener", e);
                }
            }
            anim = null;
        }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        LogUtil.d(TAG, "onDraw" + uri + " id" + System.identityHashCode(this));
        createPaints();
...
//                LogUtil.d(TAG, "[sampleSiz]" + sampleSizeKey + " [tiles]"
...
//        }
    ...
    private static class TilesInitTask extends AsyncTask<Void, Void, int[]> {
        ...
        protected int[] doInBackground(Void... params) {
            try {
                ...
                LogUtil.d(TAG, "TilesInitTask" + sourceUri);
                ...
                if (context != null && decoderFactory != null && view != null) {
                    ...
                    LogUtil.d(TAG, "bitmap width" + sWidth + " bitmap height" + sHeight);
                ...
                LogUtil.e(TAG, "Failed to initialise bitmap decoder", e);
                this.exception = e;
            }
            return null;
        }
            ...
            try {
                ...
                if (decoder != null && tile != null && view != null && decoder.isReady() && tile.visible) {
                    synchronized (view.decoderLock) {
                        ...
                        LogUtil.d(TAG, "TileLoadTask load" + tile.fileSRect);
                ...
                LogUtil.e(TAG, "Failed to decode tile", e);
                this.exception = e;
            } catch (OutOfMemoryError e) {
                LogUtil.e(TAG, "Failed to decode tile - OutOfMemoryError", e);
    ...
    private static class BitmapLoadTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            try {
                String sourceUri = source.toString();
                LogUtil.d(TAG, "BitmapLoadTask" + sourceUri);
                Context context = contextRef.get();
                ...
                LogUtil.e(TAG, "Failed to load bitmap", e);
                this.exception = e;
            } catch (OutOfMemoryError e) {
                LogUtil.e(TAG, "Failed to load bitmap - OutOfMemoryError", e);
                this.exception = new RuntimeException(e);
            }
            return null;
        }
    ...
    private synchronized void onImageLoaded(Bitmap bitmap, int sOrientation, boolean bitmapIsCached) {
        ...
        if (ready || imageLoaded) {
            invalidate();
            LogUtil.d(TAG, "ready and invalidate");
        }
    }
                ...
                if (cursor != null) {
                    if (cursor.moveToFirst()) {
                        ...
                        if (VALID_ORIENTATIONS.contains(orientation) && orientation != ORIENTATION_USE_EXIF) {
                            ...
                            LogUtil.w(TAG, "Unsupported orientation: " + orientation);
                        }
                    }
                    cursor.close();
                }
     ...
     */
    public void recycle() {
        LogUtil.d(TAG, "recycle" + uri + " id" + System.identityHashCode(this));
        reset(true);
        bitmapPaint = null;
        debugPaint = null;
        tileBgPaint = null;
