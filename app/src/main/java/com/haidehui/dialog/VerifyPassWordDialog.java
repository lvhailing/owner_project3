...
public class VerifyPassWordDialog extends Dialog implements
	...
	private OnVerifyPW onChanged = null;

	public VerifyPassWordDialog(Context context, OnVerifyPW onChanged, String info) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View mView = inflater.inflate(R.layout.dialog_verify_password, null);
	...
	private void initView(View mView) {
		...
		mEdit = (EditText) mView
				.findViewById(R.id.dialog_edit_input);
	...
	private View.OnClickListener confimListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			onChanged.onConfirm(mEdit.getText().toString());
			onDismiss();
		}
