...
import com.haidehui.uitls.DownloadUtils;
...
//		startActivity(intent);
        ...
        // 7.0以上通过FileProvider来获取安装路径
        if (Build.VERSION.SDK_INT >= 24) {
            Uri apkUri = FileProvider.getUriForFile(this, "com.haidehui.fileprovider", apkFile);//在AndroidManifest中的android:authorities值
