...
package  onekeyshare.themes.port;

import java.util.ArrayList;

import android.content.Context;
import onekeyshare.themes.PlatformPage;
import onekeyshare.themes. PlatformPageAdapter;
...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	private static final int LINE_SIZE_P = 3; // 修改一行显示的平台个数
